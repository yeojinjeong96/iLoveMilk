...
/**
 * Servlet implementation class MyPageQADetailController
 */
@WebServlet("/mypage.dq")
public class MyPageQADetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPageQADetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/notice/qa/myPageQADetailView.jsp").forward(request, response);
