...
/**
 * Servlet implementation class NoticeListManagerController
 */
@WebServlet("/listM.no")
public class NoticeListManagerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeListManagerController() {
        super();
