...
/**
 * Servlet implementation class QADetailManagerView
 */
@WebServlet("/detailM.qa")
public class QADetailManagerView extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QADetailManagerView() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/notice/qa/qaDetailManagerView.jsp").forward(request, response);
