...
/**
 * Servlet implementation class FaqManagerSearchController
 */
@WebServlet("/searchM.faq")
public class FaqManagerSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FaqManagerSearchController() {
        super();
