...
public class RecipeSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 개수
		listCount = new RecipeService().selectSearchListCount(keyword, select);
		...
		ArrayList<Recipe> list = new RecipeService().selectSearchRecipeList(pi, keyword, select);
		...
		request.getRequestDispatcher("views/recipe/recipeSearchListView.jsp").forward(request, response);
