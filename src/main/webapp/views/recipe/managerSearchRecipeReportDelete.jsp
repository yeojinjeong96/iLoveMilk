	...
	<div class="outer" align="center">
        ...
        <div class="paging-area">
            <% if(pi.getCurrentPage() != 1) { %>
                <button onclick="location.href='<%= contextPath %>/searchReportDelM.re?cpage=<%= pi.getCurrentPage()-1 %>&keyword=<%=keyword%>';" class="btn btn-primary btn-sm">&lt;</button>
            <% } %>
            
            <% for(int p=pi.getStartPage() ; p<=pi.getEndPage() ; p++) { %>
                <button onclick="location.href='<%= contextPath %>/searchReportDelM.re?cpage=<%= p %>&keyword=<%=keyword%>';" class="btn btn-primary btn-sm"><%= p %></button>
            <% } %>
        ...
        <form action="<%= contextPath %>/searchReportDelM.re?cpage=1" method="post">
