	...
	<div class="outer">
        ...
        <div align="center">
            ...
            <% if(pi.getCurrentPage() != 1) { %>
                <button onclick="location.href='<%= contextPath %>/list.re?cpage=<%= pi.getCurrentPage()-1 %>';" class="btn btn-primary btn-sm">&lt;</button>
            <% } %>
            
            <% for(int p=pi.getStartPage() ; p<=pi.getEndPage() ; p++) { %>
                <button onclick="location.href='<%= contextPath %>/list.re?cpage=<%= p %>';" class="btn btn-primary btn-sm"><%= p %></button>
            <% } %>
