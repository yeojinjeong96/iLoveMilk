	...
	<div class="outer">
        ...
        <div align="center">
            ...
            <% if(pi.getCurrentPage() != 1) { %>
                <button onclick="location.href='<%= contextPath %>/search.re?cpage=<%= pi.getCurrentPage()-1 %>&keyword=<%=keyword%>';" class="btn btn-primary btn-sm">&lt;</button>
            <% } %>
            
            <% for(int p=pi.getStartPage() ; p<=pi.getEndPage() ; p++) { %>
                <button onclick="location.href='<%= contextPath %>/search.re?cpage=<%= p %>&keyword=<%=keyword%>';" class="btn btn-primary btn-sm"><%= p %></button>
            <% } %>
