    ...
    <div class="outer" align="center">
        ...
        <div style="width:700;">
            ...
            <div class="paging-area" >
                ...
                <button onclick="location.href='<%=contextPath%>/search.faq?cpage=<%=pi.getCurrentPage()-1%>&searchFaq=<%=searchFaq%>';" class="btn btn-primary btn-sm">&lt;</button>
	            <%} %>   
	            <%for(int p= pi.getStartPage(); p<=pi.getEndPage(); p++){ %>
	                <button onclick="location.href='<%=contextPath%>/search.faq?cpage=<%=p%>&searchFaq=<%=searchFaq%>';" class="btn btn-primary btn-sm"><%=p %></button>
	            <%} %>
